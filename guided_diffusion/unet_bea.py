...
class BEAUNetModel(nn.Module):
    """
    The Boundary-Enhanced Attention UNet model with attention and timestep embedding.
    Based on UNetV2 with added Boundary-Aware Attention (BEA) mechanism.
    """
