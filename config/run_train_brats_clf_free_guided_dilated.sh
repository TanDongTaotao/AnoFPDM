...
# Windows compatible version for dilated UNet training
...
# log dir
export OPENAI_LOGDIR="./logs/clf_free_guided_dilated"
# data directory
data_dir="./data"
...
export MASTER_PORT=12357  # Use different port to avoid conflicts

NUM_GPUS=1
torchrun --nproc-per-node $NUM_GPUS \
        ./scripts/train_dilated.py --name brats \
