...
# Windows compatible version for KAN-UNet hybrid training
...
# log dir
export OPENAI_LOGDIR="./logs/clf_free_guided_kan_hybrid"
# data directory
data_dir="./data"
...
export MASTER_PORT=12358  # Use different port to avoid conflicts

NUM_GPUS=1
torchrun --nproc-per-node $NUM_GPUS \
        ./scripts/train_kan_hybrid.py --name brats \
