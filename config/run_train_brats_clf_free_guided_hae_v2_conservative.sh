...
# Windows compatible version for HAE UNet V2 Conservative training
...
in_channels=4
batch_size=28  # Increased batch size due to memory optimization
save_interval=5000
...
# log dir
export OPENAI_LOGDIR="./logs/clf_free_guided_hae_v2_conservative"
# data directory
data_dir="./data"
...
export MASTER_PORT=12362  # Different port to avoid conflicts

NUM_GPUS=1
torchrun --nproc-per-node $NUM_GPUS \
        ./scripts/train_hae_v2_conservative.py --name brats \
