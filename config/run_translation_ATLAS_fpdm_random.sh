...
do
    ...
    export OPENAI_LOGDIR="./logs_atlas/translation_fpdm_ddpm_${w}_${model_num}_${forward_steps}_${round}_last"
    echo $OPENAI_LOGDIR
    ...
    ABLATION_FLAGS="--last_only True --subset_interval -1 --t_e_ratio 1 --use_gradient_sam False --use_timestep_weights False"
