...
# Windows compatible version for HAE UNet V2 training
...
# log dir
export OPENAI_LOGDIR="./logs/clf_free_guided_hae_v2"
# data directory
data_dir="./data"
...
export MASTER_PORT=12361  # Different port to avoid conflicts

NUM_GPUS=1
torchrun --nproc-per-node $NUM_GPUS \
        ./scripts/train_hae_v2.py --name brats \
