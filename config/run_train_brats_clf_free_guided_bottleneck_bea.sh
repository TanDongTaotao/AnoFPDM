...
# Windows compatible version for Bottleneck BEA UNet training
...
# log dir
export OPENAI_LOGDIR="./logs/clf_free_guided_bottleneck_bea"
# data directory
data_dir="./data"
...
MODEL_FLAGS="--unet_ver $version --clf_free True --use_bottleneck_bea True\
...
torchrun --nproc-per-node $NUM_GPUS \
        ./scripts/train_bottleneck_bea.py --name brats \
