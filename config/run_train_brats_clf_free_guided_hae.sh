...
# Windows compatible version for HAE UNet training
...
# log dir
export OPENAI_LOGDIR="./logs/clf_free_guided_hae"
# data directory
data_dir="./data"
...
export MASTER_PORT=12359  # Different port to avoid conflicts

NUM_GPUS=1
torchrun --nproc-per-node $NUM_GPUS \
        ./scripts/train_hae.py --name brats \
