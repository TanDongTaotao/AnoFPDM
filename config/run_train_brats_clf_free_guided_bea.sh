...
# Windows compatible version for BEA UNet training
...
# log dir
export OPENAI_LOGDIR="./logs/clf_free_guided_bea"
# data directory
data_dir="./data"
...
MODEL_FLAGS="--unet_ver $version --clf_free True --use_bea True\
...
export MASTER_PORT=12357  # Different port to avoid conflicts

NUM_GPUS=1
torchrun --nproc-per-node $NUM_GPUS \
        ./scripts/train_bea.py --name brats \
