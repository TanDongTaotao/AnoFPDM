"""Train a diffusion model with Multi-layer Boundary-Enhanced Attention (Multi-BEA) UNet on images."""
...
def main():
    ...
    # Force Multi-BEA UNet version
    args.unet_ver = "multi_bea"
    
    logger.log(f"args: {args}")
    logger.log(f"Using Multi-layer Boundary-Enhanced Attention (Multi-BEA) UNet with use_multi_bea={args.use_multi_bea}")
...
def create_argparser():
    defaults = dict(
        ...
        noise_type="gaussian",
        ddpm_sampling=False,
        unet_ver="multi_bea",  # Force Multi-BEA UNet
        total_epochs=1000,
        use_multi_bea=True,  # Enable Multi-BEA by default
    )
