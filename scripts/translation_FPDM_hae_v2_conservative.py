"""Synthetic domain translation from a source 2D domain to a target using Heterogeneous Autoencoder (HAE) UNet V2 Conservative."""
...
def main():
    ...
    logger.log(f"Using Heterogeneous Autoencoder (HAE) UNet V2 Conservative with memory optimization")
    ...
    # Force HAE V2 Conservative UNet version
    args.unet_ver = "hae_v2_conservative"
...
def create_argparser():
    defaults = dict(
        ...
        unet_ver="hae_v2_conservative",  # Force HAE V2 Conservative UNet
