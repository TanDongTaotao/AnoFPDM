"""Synthetic domain translation from a source 2D domain to a target using KAN-UNet hybrid."""
...
def create_argparser():
    defaults = dict(
        ...
        unet_ver="kan_hybrid",  # Use KAN-UNet hybrid by default
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="number of batches to translate",
    )
    parser.add_argument(
        "--enable_dual_threshold",
        action="store_true",
        help="Enable dual threshold strategy for anomaly detection",
    )
    parser.add_argument(
        "--low_quant_offset",
        type=float,
        default=-0.05,
        help="Offset for low quantile in dual threshold strategy",
    )
    parser.add_argument(
        "--high_quant_offset",
        type=float,
        default=0.05,
        help="Offset for high quantile in dual threshold strategy",
    )
    parser.add_argument(
        "--entropy_weight",
        type=float,
        default=0.3,
        help="Weight for entropy-based threshold adjustment",
    )
    parser.add_argument(
        "--entropy_threshold",
        type=float,
        default=0.5,
        help="Threshold for entropy-based filtering",
    )
    parser.add_argument(
        "--enable_snr_weighting",
        action="store_true",
        help="Enable SNR-based weighting for anomaly detection",
    )
    parser.add_argument(
        "--snr_smoothing",
        type=float,
