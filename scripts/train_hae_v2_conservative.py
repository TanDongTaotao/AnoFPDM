"""Train a diffusion model with Heterogeneous Auto-Encoder (HAE) UNet V2 Conservative on images."""
...
def main():
    ...
    logger.log(f"Using Heterogeneous Auto-Encoder (HAE) UNet V2 Conservative with memory optimization")
