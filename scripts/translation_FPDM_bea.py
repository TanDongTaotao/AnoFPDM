"""Synthetic domain translation from a source 2D domain to a target using BEA UNet."""
...
def main():
    ...
    logger.log(f"Using Boundary-Enhanced Attention (BEA) UNet with use_bea={args.use_bea}")
