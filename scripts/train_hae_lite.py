"""Train a diffusion model with Heterogeneous Auto-Encoder (HAE) UNet Lite on images."""
...
def main():
    ...
    logger.log(f"Using Heterogeneous Auto-Encoder (HAE) UNet Lite with shared projection layers")
