"""Train a diffusion model with Heterogeneous Auto-Encoder (HAE) UNet V2 on images."""
...
def main():
    ...
    logger.log(f"Using Heterogeneous Auto-Encoder (HAE) UNet V2 with bottleneck MLP layers")
