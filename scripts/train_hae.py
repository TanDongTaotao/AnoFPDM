"""Train a diffusion model with Heterogeneous Auto-Encoder (HAE) UNet on images."""
...
def main():
    ...
    logger.log(f"Using Heterogeneous Auto-Encoder (HAE) UNet with hybrid CNN-Transformer decoder")
