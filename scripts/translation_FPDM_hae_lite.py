"""Synthetic domain translation from a source 2D domain to a target using Heterogeneous Autoencoder (HAE) UNet Lite."""
...
def main():
    ...
    logger.log(f"Using Heterogeneous Autoencoder (HAE) UNet Lite with shared projection layers")
    ...
    # Force HAE Lite UNet version
    args.unet_ver = "hae_lite"
...
def create_argparser():
    defaults = dict(
        ...
        unet_ver="hae_lite",  # Force HAE Lite UNet
